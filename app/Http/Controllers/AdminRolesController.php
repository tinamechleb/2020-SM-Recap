...
class AdminRolesController extends Controller
{
    ...
    {
        $rows = AdminRole::get();
        return view('admin/admin-roles/index', compact('rows'), ['page_title' => 'Admin Roles']);
    }

    public function create()
    {
        $cms_pages = CmsPage::get()->toArray();
        return view('admin/admin-roles/create', compact(
            'cms_pages'
        ), ['page_title' => 'Add Admin Role']);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin/admin-roles/show', compact('row', 'admin_role_permissions'), ['page_title' => 'Admin Role']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin' . '/admin-roles')->with('success', 'Record deleted successfully');
    }
