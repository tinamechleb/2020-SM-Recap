...
class CmsPagesController extends Controller
{
    ...
    {
        $rows = CmsPage::all();
        return view('admin/cms-pages/index', compact('rows'), ['page_title' => 'CMS Pages']);
    }
    ...
    {
        $icons = $this->icons;
        return view('admin/cms-pages/create-custom', compact('icons'), ['page_title' => 'Add Custom Page']);
    }
    ...
    public function storeCustom(Request $request)
    {
        ...
        return redirect('admin' . '/cms-pages')->with('success', 'Page added successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/cms-pages/create', compact(
            'cms_page',
            'migration_types',
            'form_fields',
            'icons'
    ...
    public function editCustom($id)
    {
        ...
        return view('admin/cms-pages/create-custom', compact(
            'cms_page',
            'icons'
        ), ['page_title' => 'Edit Custom Page']);
    }
    ...
    public function updateCustom(Request $request, $id)
    {
        ...
        return redirect('admin' . '/cms-pages')->with('success', 'Page edited successfully');
    }
    ...
    public function createModel($request)
    {
        ...
        foreach ($request->form_field as $f => $form_field) {
            if ($form_field == 'select') {
                ...
                $body .= 'public function ' . str_replace('_id', '', $request->name[$f]) . '() { return $this->belongsToMany' . "('App\\" . $second_page['model_name'] . "', '" . $pivot_table . "', '" . Str::singular($request->database_table) . '_id' . "', '" . $column_name . "')" . '; } ';
            }
        }
        ...
        file_put_contents(
            ...
            str_replace(
                ...
                file_get_contents(base_path('stubs/model.stub'))
            )
        );
    ...
    {
        $array = explode(',', $id);
        if (!count($array)) return redirect('admin' . '/cms-pages')->with('error', 'No record selected');
        foreach ($array as $id) $this->deletePage($id);
        return redirect('admin' . '/cms-pages')->with('success', 'Record deleted successfully');
    }
    ...
    {
        return view('admin/cms-pages/order', ['page_title' => 'Order CMS Pages']);
    }
    ...
    public function changeOrder(Request $request)
    {
        ...
        return redirect('admin' . '/cms-pages')->with('success', 'Records ordered successfully');
    }
    ...
    public function icons()
    {
        ...
        return view('admin/cms-pages/icons', compact('icons'), ['page_title' => "Icons"]);
    }
